"""
Django settings for django_analytice project.
...
SECRET_KEY = 'django-insecure-)+uoviu6m$)k7fu)&z8_ncc&t#q0w$lwfqw6yt)-m4bau1-5r)'
...
ROOT_URLCONF = 'django_analytice.urls'
...
WSGI_APPLICATION = 'django_analytice.wsgi.application'
